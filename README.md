...
| **此刻的事实** | 左上角那张卡（空格收起/展开）：大字时刻、日出到日落的「日弧」、太阳方位与高度、金色时刻、月相月出月落、此刻天气，外加一句人话。每一行都配了一枚手画的矢量图标，**而且可以点**：点日出/日落/月亮就跳到那一刻去看，点「窗外/风」摊开完整天气（体感、阵风、能见度、数据来源），右下角刷新立刻重问一次真实天气。|
...
| 点信息卡右上角的箭头（或按 `C`） | 把卡片收成一条，只留时间与那句话 |
| 点信息卡右下角的刷新（或按 `R`） | 立刻重问一次真实天气 |
